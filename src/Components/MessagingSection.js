      ...
      <InnerLayout>
        <div className="message-con">
          <div className="left-items">
            <h2 className="secondary-heading">Podemos te ajudar em cinco línguas diferentes</h2>
            <p className="m-para">
              Contamos com uma Equipe Internacional de Suporte e Atendimento ao Cliente pronto para tirar todas as suas
              dúvidas e auxiliá-lo em todos os procedimentos necessários.
            </p>
