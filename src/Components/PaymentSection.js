    ...
    <PaymentStyled>
      <InnerLayout>
        <h3 className="small-heading">
          Serviço de excelência, <span>com um preço acessível.</span>
        </h3>
        <p className="c-para">Você pode começar com o nosso plano gratuito e evoluir para o Platinum no futuro. </p>
        <div className="card-con">
          <Card
            account={"Gratuito"}
            amount={"R$ 0"}
            text={"Gerencie seu negócio com uma conta simples e eficiente."}
            button={"Get Started"}
            card={card}
            active={active}
            inactive={inactive}
          ...
          <Card
            account={"Platinum"}
            amount={"R$ 35"}
            text={"Aproveite todos os recursos que o Minibank oferece."}
            button={"Get Started"}
            card={card}
            active={active}
            inactive={inactive}
